...
class globvars:
    ...
    def init_globvars():
        ...
        globvars.bwl                        = []
        globvars.cc                        =  {}
        globvars.header                     = ['Symbol', 'Industry', 'Pos', 'Strike', 'Expiry', 'Status', 'UL-Init', 'BW-Price', 'UL-Last', 'UL-Chge',
         'UL-Chge pct', 'UL-Bid', 'UL-Ask', 'OP-Lst', 'OP-Bid', 'OP-Ask', 'ITV', 'ITV/$', 'CTV', 'CTV/$', 'TV-Chg']
